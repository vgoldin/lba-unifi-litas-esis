...
public class Client {
	...
	public Source customerCreditTransferInitiationV03(Source request) {
		QName serviceName = new QName("urn:lt:lba:xmlns:unifi:services:PaymentsInitiation:V01", "PaymentsInitiationV01");
		QName port = new QName("urn:lt:lba:xmlns:unifi:services:PaymentsInitiation:V01", "PaymentsInitiationV01SOAP");
		...
		ctx.put("ws-security.callback-handler", "lt.lba.xmlns.unifi.services.paymentsinitiation.v01.wsse.ClientCallback");
		...
		dispatch.getRequestContext().put(MessageContext.WSDL_OPERATION, new QName("urn:lt:lba:xmlns:unifi:services:PaymentsInitiation:V01", "CustomerCreditTransferInitiationV03"));
	...
	public static void sendLITASPayment(List<LitasPayment> rows) {
		...
		DOMSource response = (DOMSource) client.customerCreditTransferInitiationV03(request);
	...
	private static Document buildInputDocument(List<LitasPayment> rows) throws Exception {
